...
export CHECKPOINT="${CHECKPOINT:-checkpoints/interndata_a1/wan_fsdp_pilot_broad/step_000064}"
export OUTPUT="${OUTPUT:-reports/interndata_a1/wan_fsdp_pilot_broad_step64_eval_192.json}"
